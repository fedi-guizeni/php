           ...
           <form action="welcome.php" method="post " class="modal-form" id="form">
            <img src="images/logo.png" alt="">
             <div class="form-validation">
               <input type="text" class="modal-input" id="name" name="name" placeholder="Nom" autofocus>
               <p></p>
             </div> 
             <div class="form-validation">
             ...
             <div class="form-validation">
               <input type="password" class="modal-input" id="password-confirm" name="passwor" placeholder="Mot de passe">
               <p></p>
             </div> 
             <input type="submit" class="modal-input-btn" value="login" name="submit">
             <span class="modal-input-login">tu a deja un compte ?  <a href="index.php ">cliquez ici</a></span>
           </form>
          </div>
      </div>
      ...
      <div class="main" id="about">
        <div class="main__container">
          ...
          <div class="main__content">
            ...
            <button class="main__btn"> <a href="pre-inscri.html">  pré-inscrire</a></button>
          </div>
        </div>
      </div>
      <!-- services section -->
